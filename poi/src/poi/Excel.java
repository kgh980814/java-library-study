...
public class Excel {
	...
	public static void main(String[] args) {
		...
		try {
			...
			font.setColor(IndexedColors.BLUE_GREY.getIndex()); // 폰트 색 지정 Color.decode("#457ba2")
			...
			tableCellStyle.setBorderTop(BorderStyle.DASHED);    // 테두리 위쪽
			tableCellStyle.setBorderBottom(BorderStyle.DASHED); // 테두리 아래쪽
			tableCellStyle.setBorderLeft(BorderStyle.DASHED);   // 테두리 왼쪽
			tableCellStyle.setBorderRight(BorderStyle.DASHED);  // 테두리 오른쪽
